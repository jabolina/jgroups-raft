...
public class PropsToAsciidoc {
    protected static final String ROOT_PACKAGE="org.jgroups.protocols.raft";
    ...
    protected static void getDescriptions(Class<?> clazz, final Map<String,String> m, String prefix, boolean print_class)
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(Property.class)) {
                ...
                final String finalDesc = desc == null || desc.isEmpty() ? "n/a" : desc;
                m.compute(name, (ignore, curr) -> curr == null || curr.equals("n/a") ? finalDesc : curr);
            }
        }
    }
